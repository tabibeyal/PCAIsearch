...
class ExpansionPrompt:
    ...
    VERSIONS = {
        ...
        "v3": (
            ...
            "- three marks of existence: inconstant inconstancy tilakkhaṇa anicca dukkha anattā\n"
        ...
        "v5": (
            ...
            "- three marks of existence: inconstant impermanent suffering not-self → tilakkhaṇa anicca dukkha anattā\n"
