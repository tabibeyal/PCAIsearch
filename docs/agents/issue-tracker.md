...
Issues and PRDs for this repo live as GitHub issues on `tabibeyal/PCAIsearch`. Use the `gh` CLI for all operations.
...
**PRs as a request surface: no.** This repo does not treat external PRs as feature requests; `/triage` only processes issues.
